...
public class FacebookNetwork extends SocialNetwork {
    ...
    private apackage.com.yournight.model.access.AccessToken accessToken;
    ...
    private FacebookCallback<LoginResult> loginCallback = new FacebookCallback<LoginResult>() {
        ...
        public void onSuccess(LoginResult loginResult) {
            ...
            accessToken = new apackage.com.yournight.model.access.AccessToken.Builder(token)
                    .userId(userId)
                    .build();
    ...
    @Override
    public apackage.com.yournight.model.access.AccessToken getAccessToken() {
        if (AccessToken.getCurrentAccessToken() != null && accessToken == null) {
            AccessToken facebookToken = AccessToken.getCurrentAccessToken();
            accessToken = new apackage.com.yournight.model.access.AccessToken.Builder(facebookToken.getToken()).userId(facebookToken.getUserId()).build();
        }
        return accessToken;
    }
